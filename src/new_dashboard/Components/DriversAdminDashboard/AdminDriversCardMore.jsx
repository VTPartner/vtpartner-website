...
const AdminDriversCardMore = () => {
      ...
      const apiCalls = [
        {
          name: "todaysEarnings",
          call: axios.post(
            `${serverEndPoint}/get_other_drivers_today_earnings`,
            {},
            config
          ),
        },
        ...
        if (result.status === "fulfilled") {
          ...
          switch (apiCalls[index].name) {
            case "todaysEarnings":
              ...
              break;
            case "totalRides":
              // Extract total_orders from the response
  ...
  const handleCardClick = () => {
    navigate("/dashboard/all-other-drivers-orders-report");
  };
...
export default AdminDriversCardMore;
