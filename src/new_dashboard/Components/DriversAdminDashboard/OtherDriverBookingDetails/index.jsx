...
const OtherDriverBookingDetails = () => {
  ...
  const fetchBookingsDetails = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(
        `${serverEndPoint}/get_other_driver_booking_detail_with_id`,
        { booking_id },
        config
      );
                ...
                <Card className="order-details-card shadow-lg border-0">
                  ...
                  <CardBody>
                    <div className="d-flex justify-content-between mb-3">
                      ...
                      <div className="text-end">
                        <p className="mb-0">
                          {bookingDetails.driver_first_name}
                        </p>
                      </div>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
                      ...
                      <div className="text-end">
                        <p className="mb-0">
                          {bookingDetails.driver_mobile_no}
                        </p>
                      </div>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
              ...
              <Col lg={12}>
                <Card className="order-details-card shadow-lg border-0">
                  ...
                  <CardBody>
                    ...
                    <div className="d-flex justify-content-between mb-3">
                      <h6 className="f-w-600 text-dark">
                        <i className="ti ti-map-pin-filled f-s-18 me-2 text-secondary"></i>
                        Drop Location
                      </h6>
                      <div className="text-end">
                    ...
                    <div className="d-flex justify-content-between mb-3">
                      <h6 className="f-w-600 text-dark">
                        <i className="ti ti-ruler f-s-18 me-2 text-secondary"></i>
                        Distance
                      </h6>
                      <div className="text-end">
                        <span className="badge bg-primary">
...
export default OtherDriverBookingDetails;
