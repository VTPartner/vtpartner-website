  ...
  const fetchAllOrdersData = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${serverEndPoint}/get_other_driver_all_completed_orders_details`,
        { key: 1 },
        config
      );
  ...
  return (
    <div>
      <Container fluid>
        <Row className="m-1">
          <Col xs={12}>
            <h4 className="main-title">Other Drivers Orders</h4>
            <ul className="app-line-breadcrumbs mb-3">
              <li className="">
                <a href="#" className="f-s-14 f-w-500">
                  <span>
                    <i className="ph-duotone ph-car f-s-16"></i> Other Drivers
                  </span>
                </a>
              </li>
                        ...
                        <tbody>
                          {currentItems.map((order, index) => (
                            <tr key={index}>
                              ...
                              <td>
                                <Link
                                  to={`/dashboard/other-driver-order-details/${order.booking_id}/${order.order_id}`}
                                  target="_blank"
...
export default AllDriversOrders;
