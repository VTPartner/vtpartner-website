...
const OtherDriverRechargeScreen = () => {
  ...
  const fetchRechargeHistory = async () => {
    try {
      const [walletRes, historyRes] = await Promise.all([
        axios.post(`${serverEndPoint}/get_other_driver_wallet_balance`, {
          driver_id: driverId,
        }),
        axios.post(`${serverEndPoint}/get_other_driver_recharge_history`, {
          driver_id: driverId,
        }),
      ]);
  ...
  const handleRecharge = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${serverEndPoint}/add_other_wallet_transaction`, {
        driver_id: driverId,
        ...rechargeForm,
      });
  ...
  return (
    <div>
      <Container fluid>
        <Row className="m-1">
          <Col xs={12}>
            <h4 className="main-title">Other Driver Recharge History</h4>
...
export default OtherDriverRechargeScreen;
