...
const OtherDriverAboutMeCard = ({ driverData }) => {
  ...
  const handleUpdateStatus = async () => {
    try {
      ...
      const data = {
        other_driver_id: driverData.other_driver_id,
      ...
      await axios.post(`${serverEndPoint}/update_other_driver_status`, data);
      ...
      setTimeout(() => {
        html2canvas(cardRef.current, {
          ...
          const driverName =
            ...
            "Driver";
          pdf.save(`Driver_${driverName}_Details.pdf`);
        });
      }, 500); // Initial delay before canvas capture
    }
  };
...
export default OtherDriverAboutMeCard;
