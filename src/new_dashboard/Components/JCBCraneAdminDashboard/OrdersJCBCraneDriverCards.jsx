...
const OrdersJCBCraneDriverCards = () => {
      ...
      <Col lg="6" xxl="6" className="order-2-l">
        <Card className="shadow-lg border-0 rounded-lg">
          <CardBody>
            {/* Header Section */}
            <div>
              <h5 className="header-title-text">All Jcb/Crane Drivers </h5>
...
export default OrdersJCBCraneDriverCards;
