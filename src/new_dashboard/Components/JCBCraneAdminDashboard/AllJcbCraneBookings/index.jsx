...
const AllJcbCraneBookings = () => {
  ...
  const fetchAllBookingsData = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${serverEndPoint}/get_jcb_crane_driver_all_ongoing_bookings_details`,
        { allBookings: 1 },
        config
      );
  ...
  const fetchAllCancelledBookingsData = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(
        `${serverEndPoint}/get_jcb_crane_driver_all_cancelled_bookings_details`,
        {},
        config
      );
            ...
            <tr key={index}>
              ...
              <td>
                <div className="position-relative">
                  ...
                  <div className="ms-5">
                    <h6 className="mb-0 f-s-16">{order.driver_name}</h6>
                    <p className="mb-0 f-s-14 text-secondary">
  ...
  return (
    <div>
      <Container fluid>
        <Row className="m-1">
          <Col xs={12}>
            <h4 className="main-title">JCB Crane Bookings</h4>
...
export default AllJcbCraneBookings;
