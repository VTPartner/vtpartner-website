...
const JcbCraneOrderDetails = () => {
  ...
  const fetchBookingsDetails = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(
        `${serverEndPoint}/get_jcb_crane_driver_order_detail_with_id`,
        { order_id },
        config
      );
  ...
  const handleGenerateInvoice = () => {
    navigate(`/jcb-crane-invoice/${bookingDetails.order_id}`, {
              ...
              <Col lg={4}>
                <Card className="order-details-card shadow-lg border-0">
                  ...
                  <CardBody>
                    ...
                    <div className="d-flex justify-content-between mt-3">
                      <h6 className="f-w-600 text-dark">
                        <i className="ti ti-truck f-s-18 me-2"></i>
                        Current Status
                      </h6>
                      <div className="text-end">
                        <p
                ...
                <Card className="order-details-card shadow-lg border-0">
                  ...
                  <CardBody>
                    <div className="d-flex justify-content-between">
                      ...
                      <div className="text-end">
                        <p>{bookingDetails.driver_name}</p>
                      </div>
                    </div>
                    <div className="d-flex justify-content-between mt-3">
                      <h6 className="f-w-600 text-dark">
                    ...
                    <div className="d-flex justify-content-between mt-3">
                      <h6 className="f-w-600 text-dark">
                        <i className="ti ti-truck f-s-18 text-secondary me-2"></i>
                        Vehicle Type
                      </h6>
...
export default JcbCraneOrderDetails;
