            ...
            <ul className="app-line-breadcrumbs mb-3">
              <li className="">
                <a href="#" className="f-s-14 f-w-500">
                  <span>
                    <i className="ph-duotone ph-users f-s-16"></i> JCB/Crane
                  </span>
                </a>
              </li>
              <li className="active">
                ...
                <Card className="order-details-card shadow-lg border-0">
                  ...
                  <CardBody>
                    <div className="d-flex justify-content-between mb-3">
                      ...
                      <div className="text-end">
                        <p className="mb-0">{bookingDetails.driver_name}</p>
                      </div>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
                      <h6 className="f-w-600 text-dark">
...
export default JcbCraneBookingDetails;
