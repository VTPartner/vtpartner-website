...
const AllOnlineJcbCraneDrivers = () => {
    ...
    <Col lg={12}>
      <Card className="shadow-lg border-0 rounded">
        <CardHeader className="d-flex justify-content-between align-items-center">
          <h5>All Online Jcb Crane Drivers</h5>
          {noDrivers && (
            <span className="text-muted">
              No online Jcb Crane drivers available
            </span>
          )}
        </CardHeader>
        <CardBody>
          ...
          >
            {noDrivers && (
              ...
              >
                No online agents available at the moment
              </div>
            )}
          </div>
        </CardBody>
...
export default AllOnlineJcbCraneDrivers;
