...
const JcbCraneDriverRechargeScreen = () => {
  ...
  const fetchRechargeHistory = async () => {
    try {
      const [walletRes, historyRes] = await Promise.all([
        axios.post(`${serverEndPoint}/get_jcb_crane_driver_wallet_balance`, {
          driver_id: driverId,
        }),
        axios.post(`${serverEndPoint}/get_jcb_crane_driver_recharge_history`, {
          driver_id: driverId,
        }),
      ]);
  ...
  const handleRecharge = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${serverEndPoint}/add_jcb_crane_wallet_transaction`, {
        driver_id: driverId,
        ...rechargeForm,
      });
  ...
  return (
    <div>
      <Container fluid>
        <Row className="m-1">
          <Col xs={12}>
            <h4 className="main-title">JCB/Crane Driver Recharge History</h4>
            <ul className="app-line-breadcrumbs mb-3">
              ...
              <li className="active mt-2">
                <a href="#" className="f-s-14 f-w-500">
                  JCB/Crane Driver Recharge History
                </a>
              </li>
            </ul>
          </Col>
...
export default JcbCraneDriverRechargeScreen;
