...
const AdminJCBCraneDriverCard = () => {
      ...
      const apiCalls = [
        {
          name: "totalDrivers",
          call: axios.post(
            `${serverEndPoint}/get_total_jcb_crane_drivers_verified_with_count`,
            {},
            config
          ),
        },
        {
          ...
          call: axios.post(
            `${serverEndPoint}/get_total_jcb_crane_drivers_un_verified_with_count`,
            {},
            config
          ),
        },
        ...
        },
        {
          ...
          call: axios.post(
            `${serverEndPoint}/get_jcb_crane_drivers_current_month_earnings`,
            {},
            config
          ),
        },
        ...
        if (result.status === "fulfilled") {
          ...
          switch (apiCalls[index].name) {
            ...
            case "waitingApproval":
              waitingApproval = data.total_count || 0;
              break;
            case "totalEarnings":
  ...
  const handleCardClick = () => {
    navigate("/dashboard/all-jcb-crane-drivers");
  };
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="flex-shrink-0 align-self-end">
                    <p className="f-s-16 mb-0">JCB/Crane Drivers</p>
                    <h5>{totalDrivers}</h5>
                  </div>
...
export default AdminJCBCraneDriverCard;
