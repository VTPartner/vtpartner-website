...
const AdminCardMore = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [todaysEarningRes, totalRidesRes] = await Promise.all([
        axios.post(
      ...
      const totalRides = totalRidesRes.data.total_orders || 0;

      const todayEarn = todaysEarningRes.data.today_earnings || 0;
      ...
      <div className="col-lg-7 col-xxl-6">
        <div className="row">
          <div className="col-sm-6">
            <div className="card eshop-cards shadow-lg border-0 rounded shadow-lg border-0 rounded shadow-lg border-0 rounded shadow-lg border-0 rounded">
