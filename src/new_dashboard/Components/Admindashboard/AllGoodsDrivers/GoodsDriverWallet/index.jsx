...
const GoodsDriverWallet = () => {
  ...
  const fetchWalletDetails = async () => {
    try {
      const [walletRes, transactionsRes] = await Promise.all([
        ...
        axios.post(`${serverEndPoint}/get_wallet_transactions`, {
          driver_id: driverId,
        }),
      ]);
  ...
  const handleTransaction = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${serverEndPoint}/add_wallet_transaction`, {
        driver_id: driverId,
        ...transactionForm,
      });
...
export default GoodsDriverWallet;
