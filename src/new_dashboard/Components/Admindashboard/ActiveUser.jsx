          ...
          <CardBody>
            ...
            <div className="d-flex gap-2 mt-3">
              <div className="active-user-content">
                ...
                <p className="text-secondary text-nowrap mb-0">
        ...
        <Card className="shadow-lg border-0 rounded-lg">
          <CardBody>
            <div className="d-flex justify-content-between">
              ...
              <span>
                <i className="ph-bold  ph-trend-down text-danger"></i>
              </span>
            </div>
            <div>
              <div id="productSold"></div>
              <Chart
                options={productSoldChartData}
                series={productSoldChartData.series}
                type="bubble"
                height={220}
              />
              <div>
