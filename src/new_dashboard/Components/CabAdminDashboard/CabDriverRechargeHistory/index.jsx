  ...
  const fetchRechargeHistory = async () => {
    try {
      const [walletRes, historyRes] = await Promise.all([
        axios.post(`${serverEndPoint}/get_cab_driver_wallet_balance`, {
          driver_id: driverId,
        }),
        axios.post(`${serverEndPoint}/get_cab_driver_recharge_history`, {
          driver_id: driverId,
        }),
      ]);
  ...
  return (
    <div>
      <Container fluid>
        <Row className="m-1">
          <Col xs={12}>
            <h4 className="main-title">Cab Driver Recharge History</h4>
...
export default CabDriverRechargeScreen;
