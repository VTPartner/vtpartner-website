...
const AllCabBookings = () => {
  ...
  // Add new state for scheduled bookings
  ...
  const fetchAllScheduledBookingsData = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${serverEndPoint}/get_cab_scheduled_bookings_details`,
        {},
        config
      );
  ...
  const fetchAllBookingsData = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(
        `${serverEndPoint}/get_cab_all_ongoing_bookings_details`,
        { allBookings: 1 },
        config
      );
  ...
  const fetchAllCancelledBookingsData = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(
        `${serverEndPoint}/get_cab_all_cancelled_bookings_details`,
        {},
        config
      );
            ...
            <tr key={index}>
              ...
              <td>
                {order.driver_first_name != "Driver Not Assigned" && (
                  <Link
                    to={`/dashboard/cab-booking-details/${order.booking_id}`}
                    role="button"
                    target="_blank"
  ...
  return (
    <div>
      <Container fluid>
        <Row className="m-1">
          <Col xs={12}>
            <h4 className="main-title">Cab Bookings</h4>
              ...
              <CardBody>
                <ul className="nav nav-tabs app-tabs-primary order-tabs d-flex justify-content-start border-0 mb-0 pb-0">
                  ...
                  <li className="nav-item" role="presentation">
                    ...
                    >
                      <i className="ti ti-clock f-s-18 mg-b-3"></i> Scheduled
                    </button>
                  </li>
                </ul>
              </CardBody>
