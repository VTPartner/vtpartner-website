...
const CabOrderDetails = () => {
  ...
  const fetchBookingsDetails = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(
        `${serverEndPoint}/get_cab_order_detail_with_id`,
        { order_id },
        config
      );
  ...
  const handleGenerateInvoice = () => {
    navigate(`/cab-invoice/${bookingDetails.order_id}`, {
              ...
              <Col lg={4}>
                <Card className="order-details-card shadow-lg border-0">
                  ...
                  <CardBody>
                    ...
                    <div className="d-flex justify-content-between mt-3">
                      <h6 className="f-w-600 text-dark">
                        <i className="ti ti-car f-s-18 text-secondary me-2"></i>
                        Vehicle
                      </h6>
                    ...
                    <div className="d-flex justify-content-between mt-3">
                      <h6 className="f-w-600 text-dark">
                        <i className="ti ti-gas-station f-s-18 text-secondary me-2"></i>
                        Fuel Type
                      </h6>
                    ...
                    <div className="d-flex justify-content-between mt-3">
                      <h6 className="f-w-600 text-dark">
                        <i className="ti ti-license f-s-18 text-secondary me-2"></i>
                        Plate No
                      </h6>
...
export default CabOrderDetails;
