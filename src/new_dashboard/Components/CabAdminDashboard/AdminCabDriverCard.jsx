...
const AdminCabDriverCard = () => {
      ...
      const apiCalls = [
        {
          name: "totalDrivers",
          call: axios.post(
            `${serverEndPoint}/get_total_cab_drivers_verified_with_count`,
            {},
            config
          ),
        },
        {
          ...
          call: axios.post(
            `${serverEndPoint}/get_total_cab_drivers_un_verified_with_count`,
            {},
            config
          ),
        },
        {
          name: "totalEarnings",
          call: axios.post(
            `${serverEndPoint}/get_total_cab_drivers_orders_and_earnings`,
            {},
            config
          ),
        },
        {
          ...
          call: axios.post(
            `${serverEndPoint}/get_cab_drivers_current_month_earnings`,
            {},
            config
          ),
        },
        ...
        if (result.status === "fulfilled") {
          switch (apiCalls[index].name) {
            ...
            case "waitingApproval":
              waitingApproval =
                result.value.data["drivers"][0]["total_count"] || 0;
              break;
            case "totalEarnings":
  ...
  const handleCardClick = () => {
    navigate("/dashboard/all-cab-drivers");
  };
  const handleOrderClick = () => {
    navigate("/dashboard/cab/orders");
  };
...
export default AdminCabDriverCard;
