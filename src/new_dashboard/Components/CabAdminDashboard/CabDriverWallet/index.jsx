...
const CabDriverWallet = () => {
  ...
  const fetchWalletDetails = async () => {
    try {
      const [walletRes, transactionsRes] = await Promise.all([
        ...
        axios.post(`${serverEndPoint}/get_cab_wallet_transactions`, {
          driver_id: driverId,
        }),
      ]);
  ...
  const handleTransaction = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${serverEndPoint}/add_cab_wallet_transaction`, {
        driver_id: driverId,
        ...transactionForm,
      });
      ...
      <Card className="m-4">
        <CardBody>
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div>
              <h1>Cab Driver Name - {driverName}</h1>
...
export default CabDriverWallet;
