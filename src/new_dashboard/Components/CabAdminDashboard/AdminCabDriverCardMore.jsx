...
const AdminCabDriverCardMore = () => {
    ...
    try {
      ...
      const apiCalls = [
        {
          name: "todaysEarnings",
          call: axios.post(
            `${serverEndPoint}/get_cab_drivers_today_earnings`,
            {},
            config
          ),
        },
      ...
      results.forEach((result, index) => {
        if (result.status === "fulfilled") {
          ...
          // Keep the default 0.0 value for the failed API
        }
      });
  ...
  const handleCardClick = () => {
    navigate("/dashboard/all-cab-orders-report");
  };
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="flex-shrink-0 align-self-end">
                    <p className="f-s-16 mb-0">Total Rides Completed</p>
                    <h5>{totalRides}</h5>
                  </div>
...
export default AdminCabDriverCardMore;
