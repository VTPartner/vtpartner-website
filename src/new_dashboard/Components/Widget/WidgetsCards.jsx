        ...
        <Card className="shadow-lg border-0 rounded-lg">
          <CardBody className="p-0">
            ...
            <div className="project-earning-chart">
              <Chart
                options={projectEarning}
                series={projectEarning.series}
                type="line"
                height={190}
              />
            </div>
            ...
            <div className="p-3 project-earning-content">
              <p className="mb-0">
                In the symphony of success, our total project income resonates
                as the crescendo of our endeavors.
              </p>
            </div>
          </CardBody>
        </Card>
            ...
            <Col sm="6" key={course.id} className="mb-3">
              <Card className={`courses-cards ${course.cardClass}`}>
                <CardBody>
                  ...
                  <span className="bg-white h-50 w-50 d-flex justify-content-center align-items-center rounded">
                    <i
                      className={`${course.iconClass} ${course.iconColorClass} f-s-24`}
                    />
                  </span>
                  <div className="mt-5">
                    <h4>{course.value}</h4>
