      ...
      <Col lg="6" xxl="6" className="order-2-l">
        <Card className="shadow-lg border-0 rounded-lg">
          <CardBody>
            {/* Header Section */}
            <div>
              <h5 className="header-title-text">All HandyMan Agents </h5>
      ...
      <Col lg="6" xxl="6" className="order-2-l">
        <Card className="shadow-lg border-0 rounded-lg">
          <CardBody>
            {/* Header Section */}
            <div>
              <h5 className="header-title-text">HandyMan Bookings & Orders </h5>
              {/* <p className="fs-16 text-secondary mb-0">Latest 2H Update</p> */}
            </div>
            <div className="recent-order-table">
              <Nav
...
export default OrdersHandyManCards;
