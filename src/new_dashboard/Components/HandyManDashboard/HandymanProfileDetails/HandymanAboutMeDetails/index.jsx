...
const HandyManAboutMeCard = ({ driverData }) => {
  ...
  const handleUpdateStatus = async () => {
    try {
      ...
      const data = {
        handyman_id: driverData.handyman_id,
      ...
      await axios.post(`${serverEndPoint}/update_handyman_status`, data);

      Toast.fire({
        icon: "success",
        title: `${driverData.name} Status Updated Successfully`,
      });
      ...
      setTimeout(() => {
        html2canvas(cardRef.current, {
          ...
          printWindow.document.write(`
            ...
            <html>
            <head>
              <title>Agent Details - Print</title>
              <style>
                @page {
    ...
    if (cardRef.current) {
      setTimeout(() => {
        html2canvas(cardRef.current, {
          ...
          const driverName =
            driverData?.driver_name || driverData?.name || "Driver";
          pdf.save(`HandyMan_Agent_${driverName}_Details.pdf`);
        });
      }, 500); // Initial delay before canvas capture
    }
  };
        ...
        <CardBody>
          <div className="profile-container">
            ...
            <div className="person-details">
              <h5 className="f-w-600">{driverData.name}</h5>
              <p>Handyman Agent</p>
...
export default HandyManAboutMeCard;
