...
import { CitySelectorMobile, CitySelection } from "../components";
...
const HorizontalFareEstimation = ({ onCitySelect }) => {
  ...
  return (
    <div
      className={` ${styles.padding} mt-[-32rem] relative z-10 p-[3rem 2.4rem 3rem .4rem] lg:flex hidden flex-col items-center`}
    >
...
export default HorizontalFareEstimation;
